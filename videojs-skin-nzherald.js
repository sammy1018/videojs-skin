...
(function (global, factory) {
	...
	var SkinNzherald = /*#__PURE__*/function (_Plugin) {
	  inheritsLoose(SkinNzherald, _Plugin);
	   ...
	   */
	  function SkinNzherald(player, options) {
	    var _this;
	    ...
	    _this.player.ready(function () {
	      _this.player.addClass('vjs-skin-nzherald');
	    });
	...
	SkinNzherald.defaultState = {}; // Include the version number.

	SkinNzherald.VERSION = version; // Register the plugin with video.js.
